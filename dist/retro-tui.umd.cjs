...
`;var Re=Object.defineProperty,Le=Object.getOwnPropertyDescriptor,z=(n,e,t,o)=>{for(var r=o>1?void 0:o?Le(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&Re(e,t,r),r};s.App=class extends l.LitElement{constructor(){super(...arguments),this.title="TUI",this.subtitle="",this.compact=!1,this.decorations="full",this._focusContext="workspace",this._menuOpen=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("mousedown",()=>this.classList.add("using-mouse")),this.addEventListener("keydown",e=>{e.key==="Tab"&&this.classList.remove("using-mouse"),this._handleGlobalKeydown(e)})}_handleGlobalKeydown(e){if(e.key==="Escape"){this._menuOpen&&(this._menuOpen=!1,e.preventDefault());return}e.key==="Tab"&&!e.ctrlKey&&e.altKey}render(){const e=this.subtitle?l.html`░░ ${this.title} <span>[ ${this.subtitle} ]</span> ░░`:l.html`░░ ${this.title} ░░`;return l.html`
    ...
    `],V([c({type:String,reflect:!0})],s.Sidebar.prototype,"side",2),V([c({type:Number})],s.Sidebar.prototype,"size",2),V([g()],s.Sidebar.prototype,"_dropIndex",2),s.Sidebar=V([p("tui-sidebar")],s.Sidebar);const L={single:{tl:"┌",tr:"┐",bl:"└",br:"┘",h:"─",v:"│"},heavy:{tl:"┏",tr:"┓",bl:"┗",br:"┛",h:"━",v:"┃"},double:{tl:"╔",tr:"╗",bl:"╚",br:"╝",h:"═",v:"║"},rounded:{tl:"╭",tr:"╮",bl:"╰",br:"╯",h:"─",v:"│"}};function fe(n){return n==="none"?null:L[n]}function H(n){const e=fe(n);return e?{before:`${e.tl}${e.h} `,after:` ${e.h}${e.tr}`}:{before:"",after:""}}const We={neutral:"single",hover:"heavy",selected:"double"};var Ye=Object.defineProperty,Ue=Object.getOwnPropertyDescriptor,b=(n,e,t,o)=>{for(var r=o>1?void 0:o?Ue(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&Ye(e,t,r),r};s.Panel=class extends l.LitElement{constructor(){super(...arguments),this.title="",this.color="",this.border="single",this.variant="bright",this.selectionStyle="",this.collapsible=!1,this.collapsed=!1,this.selected=!1,this.active=!1,this.persistId="",this.dismissable=!1,this.full=!1,this.floating=!1,this.snapEdge="",this.positionX=0,this.positionY=0,this.resizable=!1,this.minimized=!1,this.panelWidth=null,this.panelHeight=null,this.maxWidth=null,this.maxHeight=null,this.minWidth=150,this.minHeight=100,this.docked="",this._isDragging=!1,this._dragStartX=0,this._dragStartY=0,this._dragOffsetX=0,this._dragOffsetY=0,this._isResizing=!1,this._resizeStartX=0,this._resizeStartY=0,this._resizeStartWidth=0,this._resizeStartHeight=0,this._preMinimizeX=0,this._preMinimizeY=0,this._preMinimizeWidth=null,this._preMinimizeHeight=null,this._handleClick=()=>{this.dispatchEvent(new CustomEvent("focus-request",{bubbles:!0,composed:!0,detail:{panel:this}}))},this._onEdgeTabClick=()=>{this.restore()},this._onDragStart=e=>{if(!this.floating&&!this.docked)return;const t=e.target;t.closest(".collapse-btn")||t.closest(".dismiss-btn")||(e.preventDefault(),this._isDragging=!0,this._dragStartX=e.clientX,this._dragStartY=e.clientY,this._dragOffsetX=this.positionX,this._dragOffsetY=this.positionY,document.addEventListener("pointermove",this._onDragMove),document.addEventListener("pointerup",this._onDragEnd))},this._onDragMove=e=>{if(!this._isDragging)return;const t=e.clientX-this._dragStartX,o=e.clientY-this._dragStartY;this.positionX=this._dragOffsetX+t,this.positionY=this._dragOffsetY+o,this.dispatchEvent(new CustomEvent("panel-move",{detail:{panelId:this.id||this.title,x:this.positionX,y:this.positionY,cursorY:e.clientY},bubbles:!0,composed:!0}))},this._onDragEnd=()=>{this._isDragging=!1,document.removeEventListener("pointermove",this._onDragMove),document.removeEventListener("pointerup",this._onDragEnd),this.dispatchEvent(new CustomEvent("panel-drag-end",{detail:{panelId:this.id||this.title,x:this.positionX,y:this.positionY},bubbles:!0,composed:!0}))},this._onResizeStart=e=>{this.resizable&&(e.preventDefault(),e.stopPropagation(),this._isResizing=!0,this._resizeStartX=e.clientX,this._resizeStartY=e.clientY,this._resizeStartWidth=this.panelWidth??this.offsetWidth,this._resizeStartHeight=this.panelHeight??this.offsetHeight,document.addEventListener("pointermove",this._onResizeMove),document.addEventListener("pointerup",this._onResizeEnd))},this._onResizeMove=e=>{if(!this._isResizing)return;const t=e.clientX-this._resizeStartX,o=e.clientY-this._resizeStartY;let r=this._resizeStartWidth+t,i=this._resizeStartHeight+o;r=Math.max(this.minWidth,r),i=Math.max(this.minHeight,i),this.maxWidth!==null&&(r=Math.min(this.maxWidth,r)),this.maxHeight!==null&&(i=Math.min(this.maxHeight,i)),this.panelWidth=r,this.panelHeight=i,this.dispatchEvent(new CustomEvent("panel-resize",{detail:{panelId:this.id||this.title,width:this.panelWidth,height:this.panelHeight},bubbles:!0,composed:!0}))},this._onResizeEnd=()=>{this._isResizing=!1,document.removeEventListener("pointermove",this._onResizeMove),document.removeEventListener("pointerup",this._onResizeEnd)},this._onCollapseClick=e=>{e.stopPropagation(),this.toggle()},this._onDismissClick=e=>{e.stopPropagation(),this.dismiss()}}connectedCallback(){if(super.connectedCallback(),this.persistId){const e=localStorage.getItem(`tui-panel-${this.persistId}`);e!==null&&(this.collapsed=e==="true")}this.addEventListener("click",this._handleClick)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this._handleClick),document.removeEventListener("pointermove",this._onDragMove),document.removeEventListener("pointerup",this._onDragEnd),document.removeEventListener("pointermove",this._onResizeMove),document.removeEventListener("pointerup",this._onResizeEnd)}toggle(){this.collapsible&&(this.collapsed=!this.collapsed,this.persistId&&localStorage.setItem(`tui-panel-${this.persistId}`,String(this.collapsed)),this.dispatchEvent(new CustomEvent("toggle",{detail:{collapsed:this.collapsed},bubbles:!0,composed:!0})))}dismiss(){if(this.floating&&this.dismissable){this.minimize();return}if(this.persistId){const o={x:this.positionX,y:this.positionY,width:this.panelWidth,height:this.panelHeight,collapsed:this.collapsed,snapEdge:this.snapEdge};localStorage.setItem(`tui-panel-memory-${this.persistId}`,JSON.stringify(o))}const e=new CustomEvent("panel-dismiss",{detail:{panelId:this.id||this.title},bubbles:!0,composed:!0,cancelable:!0});this.dispatchEvent(e)&&(this.hidden=!0)}minimize(){if(!this.minimized){if(this._preMinimizeX=this.positionX,this._preMinimizeY=this.positionY,this._preMinimizeWidth=this.panelWidth,this._preMinimizeHeight=this.panelHeight,this.snapEdge||(this.snapEdge="left"),this.minimized=!0,this.persistId){const e={minimized:!0,preMinimize:{x:this._preMinimizeX,y:this._preMinimizeY,width:this._preMinimizeWidth,height:this._preMinimizeHeight},snapEdge:this.snapEdge};localStorage.setItem(`tui-panel-memory-${this.persistId}`,JSON.stringify(e))}this.dispatchEvent(new CustomEvent("panel-minimize",{detail:{panelId:this.id||this.title},bubbles:!0,composed:!0}))}}restore(){if(this.minimized){if(this.positionX=this._preMinimizeX,this.positionY=this._preMinimizeY,this._preMinimizeWidth!==null&&(this.panelWidth=this._preMinimizeWidth),this._preMinimizeHeight!==null&&(this.panelHeight=this._preMinimizeHeight),this.minimized=!1,this.persistId){const e={minimized:!1,x:this.positionX,y:this.positionY,width:this.panelWidth,height:this.panelHeight,collapsed:this.collapsed,snapEdge:this.snapEdge};localStorage.setItem(`tui-panel-memory-${this.persistId}`,JSON.stringify(e))}this.dispatchEvent(new CustomEvent("panel-restore",{detail:{panelId:this.id||this.title},bubbles:!0,composed:!0}))}}restorePosition(){var t,o,r,i;if(!this.persistId)return!1;const e=localStorage.getItem(`tui-panel-memory-${this.persistId}`);if(!e)return!1;try{const a=JSON.parse(e);return a.minimized?(this._preMinimizeX=((t=a.preMinimize)==null?void 0:t.x)??0,this._preMinimizeY=((o=a.preMinimize)==null?void 0:o.y)??0,this._preMinimizeWidth=((r=a.preMinimize)==null?void 0:r.width)??null,this._preMinimizeHeight=((i=a.preMinimize)==null?void 0:i.height)??null,this.snapEdge=a.snapEdge||"left",this.minimized=!0,!0):(a.x!==void 0&&(this.positionX=a.x),a.y!==void 0&&(this.positionY=a.y),a.width!==void 0&&(this.panelWidth=a.width),a.height!==void 0&&(this.panelHeight=a.height),a.collapsed!==void 0&&(this.collapsed=a.collapsed),a.snapEdge!==void 0&&(this.snapEdge=a.snapEdge),!0)}catch(a){return console.warn(`[tui-panel] Failed to restore position for ${this.persistId}:`,a),!1}}firstUpdated(){this.minimized&&this.floating&&(this._preMinimizeX=this.positionX,this._preMinimizeY=this.positionY,this.snapEdge||(this.snapEdge="left")),this.floating&&!this.minimized&&(this.style.left=`${this.positionX}px`,this.style.top=`${this.positionY}px`)}willUpdate(e){this.full&&this.floating&&(this.floating=!1)}updated(e){if(this.minimized){this.snapEdge==="right"?(this.style.left="auto",this.style.right="0"):(this.style.left="0",this.style.right="auto"),this.style.top=`${this.positionY}px`,this.style.width="",this.style.height="",this.style.minWidth="",this.style.minHeight="";return}this.floating&&(e.has("positionX")||e.has("positionY")||e.has("floating")||e.has("minimized"))&&(this.style.left=`${this.positionX}px`,this.style.top=`${this.positionY}px`,this.style.right="auto"),e.has("panelWidth")&&this.panelWidth!==null&&(this.style.width=`${this.panelWidth}px`),(e.has("panelHeight")||e.has("collapsed"))&&(this.collapsed?this.style.height="":this.panelHeight!==null&&(this.style.height=`${this.panelHeight}px`)),e.has("maxWidth")&&this.maxWidth!==null&&(this.style.maxWidth=`${this.maxWidth}px`),e.has("maxHeight")&&this.maxHeight!==null&&(this.style.maxHeight=`${this.maxHeight}px`),e.has("minWidth")&&(this.style.minWidth=`${this.minWidth}px`),e.has("minHeight")&&!this.collapsed?this.style.minHeight=`${this.minHeight}px`:this.collapsed&&e.has("collapsed")&&(this.style.minHeight="")}render(){return this.minimized?l.html`
      ...
      <div class="panel ${this.collapsed?"collapsed":""}">
        ...
        >
          <span class="title"><span class="title-decor">${H(this.border).before}</span>${this.title}<span class="title-decor">${H(this.border).after}</span></span>
    ...
    `],b([c({type:String})],s.Panel.prototype,"title",2),b([c({type:String})],s.Panel.prototype,"color",2),b([c({type:String,reflect:!0})],s.Panel.prototype,"border",2),b([c({type:String,reflect:!0})],s.Panel.prototype,"variant",2),b([c({type:String,attribute:"selection-style",reflect:!0})],s.Panel.prototype,"selectionStyle",2),b([c({type:Boolean})],s.Panel.prototype,"collapsible",2),b([c({type:Boolean,reflect:!0})],s.Panel.prototype,"collapsed",2),b([c({type:Boolean,reflect:!0})],s.Panel.prototype,"selected",2),b([c({type:Boolean,reflect:!0})],s.Panel.prototype,"active",2),b([c({type:String,attribute:"persist-id"})],s.Panel.prototype,"persistId",2),b([c({type:Boolean,reflect:!0})],s.Panel.prototype,"dismissable",2),b([c({type:Boolean,reflect:!0})],s.Panel.prototype,"full",2),b([c({type:Boolean,reflect:!0})],s.Panel.prototype,"floating",2),b([c({type:String,attribute:"snap-edge",reflect:!0})],s.Panel.prototype,"snapEdge",2),b([c({type:Number,attribute:"position-x"})],s.Panel.prototype,"positionX",2),b([c({type:Number,attribute:"position-y"})],s.Panel.prototype,"positionY",2),b([c({type:Boolean,reflect:!0})],s.Panel.prototype,"resizable",2),b([c({type:Boolean,reflect:!0})],s.Panel.prototype,"minimized",2),b([c({type:Number,attribute:"panel-width"})],s.Panel.prototype,"panelWidth",2),b([c({type:Number,attribute:"panel-height"})],s.Panel.prototype,"panelHeight",2),b([c({type:Number,attribute:"max-width"})],s.Panel.prototype,"maxWidth",2),b([c({type:Number,attribute:"max-height"})],s.Panel.prototype,"maxHeight",2),b([c({type:Number,attribute:"min-width"})],s.Panel.prototype,"minWidth",2),b([c({type:Number,attribute:"min-height"})],s.Panel.prototype,"minHeight",2),b([c({type:String,reflect:!0,converter:{fromAttribute:n=>n||"",toAttribute:n=>n||null}})],s.Panel.prototype,"docked",2),s.Panel=b([p("tui-panel")],s.Panel);const be={30:"black",31:"red",32:"green",33:"yellow",34:"blue",35:"magenta",36:"cyan",37:"white",90:"black",91:"red",92:"green",93:"yellow",94:"blue",95:"magenta",96:"cyan",97:"white"},ve={40:"black",41:"red",42:"green",43:"yellow",44:"blue",45:"magenta",46:"cyan",47:"white",100:"black",101:"red",102:"green",103:"yellow",104:"blue",105:"magenta",106:"cyan",107:"white"},ge={1:"bold",2:"dim",3:"italic",4:"underline",7:"reverse",9:"strikethrough"};function ye(n){const e=["#000000","#aa0000","#00aa00","#aa5500","#0000aa","#aa00aa","#00aaaa","#aaaaaa"],t=["#555555","#ff5555","#55ff55","#ffff55","#5555ff","#ff55ff","#55ffff","#ffffff"];if(n<8)return e[n];if(n<16)return t[n-8];if(n<232){const i=n-16,a=Math.floor(i/36),d=Math.floor(i%36/6),h=i%6,u=f=>(f===0?0:55+f*40).toString(16).padStart(2,"0");return`#${u(a)}${u(d)}${u(h)}`}const r=(8+(n-232)*10).toString(16).padStart(2,"0");return`#${r}${r}${r}`}function K(n){if(!n)return"";let e=n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");const t=/\x1b\[([0-9;]+)m/g;let o="",r=0,i=[],a;for(;(a=t.exec(e))!==null;){o+=e.slice(r,a.index),r=a.index+a[0].length;const d=a[1].split(";").map(Number);for(let h=0;h<d.length;h++){const u=d[h];if(u===0)o+=i.map(()=>"</span>").join(""),i=[];else if(u===38&&d[h+1]===5&&d[h+2]!==void 0){const f=ye(d[h+2]);o+=`<span style="color: ${f}">`,i.push("256fg"),h+=2}else if(u===48&&d[h+1]===5&&d[h+2]!==void 0){const f=ye(d[h+2]);o+=`<span style="background-color: ${f}">`,i.push("256bg"),h+=2}else if(u===38&&d[h+1]===2&&d.length>h+4){const f=d[h+2],v=d[h+3],_=d[h+4];o+=`<span style="color: rgb(${f},${v},${_})">`,i.push("tcfg"),h+=4}else if(u===48&&d[h+1]===2&&d.length>h+4){const f=d[h+2],v=d[h+3],_=d[h+4];o+=`<span style="background-color: rgb(${f},${v},${_})">`,i.push("tcbg"),h+=4}else if(be[u]){const f=`ansi-${be[u]}`;o+=`<span class="${f}">`,i.push(f)}else if(ve[u]){const f=`ansi-bg-${ve[u]}`;o+=`<span class="${f}">`,i.push(f)}else if(ge[u]){const f=`ansi-${ge[u]}`;o+=`<span class="${f}">`,i.push(f)}}}return o+=e.slice(r),o+=i.map(()=>"</span>").join(""),o}var Xe=Object.defineProperty,Fe=Object.getOwnPropertyDescriptor,O=(n,e,t,o)=>{for(var r=o>1?void 0:o?Fe(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&Xe(e,t,r),r};s.Output=class extends l.LitElement{constructor(){super(...arguments),this.maxLines=500,this.autoscroll=!0,this.timestamps=!1,this.attr="",this._lines=[]}append(e){const t=this.timestamps?new Date().toLocaleTimeString("en-US",{hour12:!1}):null,o=e.split(`
`).map(r=>({id:Date.now()+Math.random(),text:r,html:K(r),timestamp:t}));this._lines=[...this._lines,...o].slice(-this.maxLines),this.autoscroll&&this._isNearBottom()&&this.updateComplete.then(()=>this.scrollToBottom())}clear(){this._lines=[]}handleEvent(e){if(e.type==="clear"){this.clear();return}const t=e.data;t.message!=null&&this.append(t.message)}_isNearBottom(){var o;const e=(o=this.shadowRoot)==null?void 0:o.querySelector(".output");return e?e.scrollHeight-e.scrollTop-e.clientHeight<30:!0}scrollToBottom(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".output");e&&(e.scrollTop=e.scrollHeight)}get _attrClasses(){return this.attr.split(/\s+/).filter(Boolean).map(e=>`tui-${e}`).join(" ")}render(){return l.html`
    ...
    `],O([c({type:Number,attribute:"max-lines"})],s.Output.prototype,"maxLines",2),O([c({type:Boolean})],s.Output.prototype,"autoscroll",2),O([c({type:Boolean})],s.Output.prototype,"timestamps",2),O([c({type:String})],s.Output.prototype,"attr",2),O([g()],s.Output.prototype,"_lines",2),s.Output=O([p("tui-output")],s.Output);var qe=Object.defineProperty,Ge=Object.getOwnPropertyDescriptor,Z=(n,e,t,o)=>{for(var r=o>1?void 0:o?Ge(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&qe(e,t,r),r};s.Table=class extends l.LitElement{constructor(){super(...arguments),this.border="single",this._columns=[],this._rows=[]}setData(e,t){this._columns=e,this._rows=t}upsertRow(e,t){const o=this._rows.findIndex(r=>r[this._columns[0]]===e);o>=0?this._rows=[...this._rows.slice(0,o),t,...this._rows.slice(o+1)]:this._rows=[...this._rows,t]}handleEvent(e){if(e.type==="clear"){this._columns=[],this._rows=[];return}const t=e.data;if("columns"in t&&"rows"in t){const o=t;this.setData(o.columns,o.rows)}else if("key"in t&&"row"in t){const o=t;this.upsertRow(o.key,o.row)}}getCellClass(e){return typeof e=="number"?"number":e==="✓"||e==="OK"||e==="online"?"status-ok":e==="⚠"||e==="WARN"||e==="degraded"?"status-warn":e==="✗"||e==="ERROR"||e==="offline"?"status-error":""}render(){return this._columns.length===0?l.html`<div class="empty">No data</div>`:l.html`
      <div class="table">
...
`).map(o=>({id:Date.now()+Math.random(),text:o,html:K(o),type:"output"}));this._lines=[...this._lines,...t],this.updateComplete.then(()=>this.scrollToBottom())}clear(){this._lines=[]}handleEvent(e){if(e.type==="clear"){this.clear();return}const t=e.data;t.message!=null&&this.print(t.message)}scrollToBottom(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector(".output");e&&(e.scrollTop=e.scrollHeight)}focusInput(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("input");e==null||e.focus()}handleKeydown(e){switch(e.key){case"Enter":this.submitCommand();break;case"ArrowUp":e.preventDefault(),this.navigateHistory(1);break;case"ArrowDown":e.preventDefault(),this.navigateHistory(-1);break;case"l":e.ctrlKey&&(e.preventDefault(),this.clear());break;case"c":e.ctrlKey&&(e.preventDefault(),this._inputValue="",this.print("^C"));break}}submitCommand(){const e=this._inputValue.trim();e&&(this._lines=[...this._lines,{id:Date.now(),text:e,html:e,type:"command",prompt:this.prompt}],this._history=[...this._history.slice(-this.historySize+1),e],this._historyIndex=-1,this._inputValue="",this.dispatchEvent(new CustomEvent("command",{detail:e,bubbles:!0,composed:!0})),this.updateComplete.then(()=>this.scrollToBottom()))}navigateHistory(e){const t=this._historyIndex+e;t<0?(this._historyIndex=-1,this._inputValue=""):t<this._history.length&&(this._historyIndex=t,this._inputValue=this._history[this._history.length-1-t])}handleInput(e){this._inputValue=e.target.value}get _promptClasses(){return["prompt",...this.promptAttr.split(/\s+/).filter(Boolean).map(e=>`tui-${e}`)].join(" ")}render(){return l.html`
    ...
    `],k([c({type:String})],s.Console.prototype,"prompt",2),k([c({type:String,attribute:"prompt-attr"})],s.Console.prototype,"promptAttr",2),k([c({type:Number,attribute:"history-size"})],s.Console.prototype,"historySize",2),k([g()],s.Console.prototype,"_lines",2),k([g()],s.Console.prototype,"_inputValue",2),k([g()],s.Console.prototype,"_historyIndex",2),s.Console=k([p("tui-console")],s.Console);var Ze=Object.defineProperty,Je=Object.getOwnPropertyDescriptor,J=(n,e,t,o)=>{for(var r=o>1?void 0:o?Je(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&Ze(e,t,r),r};s.Text=class extends l.LitElement{constructor(){super(...arguments),this.content="",this.attr="",this.variant=""}render(){const e=this.attr.split(/\s+/).filter(Boolean).map(o=>`tui-${o}`).join(" "),t=K(this.content||this.textContent||"");return l.html`<pre class="${e}" .innerHTML=${t}></pre>`}},s.Text.styles=[m,l.css`
      :host {
        display: block;
      }
    ...
    `],J([c({type:String})],s.Text.prototype,"content",2),J([c({type:String})],s.Text.prototype,"attr",2),J([c({type:String,reflect:!0})],s.Text.prototype,"variant",2),s.Text=J([p("tui-text")],s.Text);var Qe=Object.defineProperty,et=Object.getOwnPropertyDescriptor,x=(n,e,t,o)=>{for(var r=o>1?void 0:o?et(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&Qe(e,t,r),r};s.Button=class extends l.LitElement{constructor(){super(...arguments),this.variant="default",this.size="md",this.selected=!1,this.disabled=!1,this.block=!1}render(){return l.html`
    ...
    `],w([c({type:String})],s.MenuItem.prototype,"label",2),w([c({type:String})],s.MenuItem.prototype,"hotkey",2),w([g()],s.MenuItem.prototype,"_open",2),s.MenuItem=w([p("tui-menu-item")],s.MenuItem),s.MenuAction=class extends l.LitElement{constructor(){super(...arguments),this.label="",this.shortcut="",this.danger=!1}_handleClick(){this.dispatchEvent(new CustomEvent("action",{bubbles:!0,composed:!0}))}render(){return l.html`
    ...
    `],w([c({type:String})],s.MenuAction.prototype,"label",2),w([c({type:String})],s.MenuAction.prototype,"shortcut",2),w([c({type:Boolean,reflect:!0})],s.MenuAction.prototype,"danger",2),s.MenuAction=w([p("tui-menu-action")],s.MenuAction),s.MenuDivider=class extends l.LitElement{render(){return l.html``}},s.MenuDivider.styles=l.css`
    :host {
      display: block;
      height: 1px;
      background: var(--border-default);
  ...
  `,s.MenuDivider=w([p("tui-menu-divider")],s.MenuDivider);var ot=Object.defineProperty,st=Object.getOwnPropertyDescriptor,T=(n,e,t,o)=>{for(var r=o>1?void 0:o?st(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&ot(e,t,r),r};s.Statusbar=class extends l.LitElement{constructor(){super(...arguments),this.color="magenta"}render(){return l.html`<slot></slot>`}},s.Statusbar.styles=[m,l.css`
      :host {
    ...
    `],T([c({type:String,reflect:!0})],s.Statusbar.prototype,"color",2),s.Statusbar=T([p("tui-statusbar")],s.Statusbar),s.StatusItem=class extends l.LitElement{constructor(){super(...arguments),this.label="",this.value="",this.highlight=!1}render(){return l.html`
    ...
    `],T([c({type:String})],s.StatusItem.prototype,"label",2),T([c({type:String})],s.StatusItem.prototype,"value",2),T([c({type:Boolean,reflect:!0})],s.StatusItem.prototype,"highlight",2),s.StatusItem=T([p("tui-status-item")],s.StatusItem);var it=Object.defineProperty,at=Object.getOwnPropertyDescriptor,j=(n,e,t,o)=>{for(var r=o>1?void 0:o?at(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&it(e,t,r),r};s.Modal=class extends l.LitElement{constructor(){super(...arguments),this.title="",this.border="double",this.open=!1,this.closable=!0,this._boundKeyHandler=this._handleKeydown.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this._boundKeyHandler)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("keydown",this._boundKeyHandler)}_handleKeydown(e){this.open&&e.key==="Escape"&&this.closable&&(this.close(),e.preventDefault(),e.stopPropagation())}_handleOverlayClick(e){e.target===e.currentTarget&&this.closable&&this.close()}show(){this.open=!0,this.dispatchEvent(new CustomEvent("open",{bubbles:!0,composed:!0}))}close(){this.open=!1,this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}render(){return l.html`
      <div class="overlay" @click=${this._handleOverlayClick}>
        <div class="modal" role="dialog" aria-modal="true" aria-labelledby="modal-title">
          <div class="header">
            <span class="title" id="modal-title"><span class="title-decor">${H(this.border).before}</span>${this.title}<span class="title-decor">${H(this.border).after}</span></span>
    ...
    `],j([c({type:String,reflect:!0})],s.Modal.prototype,"title",2),j([c({type:String,reflect:!0})],s.Modal.prototype,"border",2),j([c({type:Boolean,reflect:!0})],s.Modal.prototype,"open",2),j([c({type:Boolean})],s.Modal.prototype,"closable",2),s.Modal=j([p("tui-modal")],s.Modal);var nt=Object.defineProperty,lt=Object.getOwnPropertyDescriptor,y=(n,e,t,o)=>{for(var r=o>1?void 0:o?lt(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&nt(e,t,r),r};s.Toolbar=class extends l.LitElement{constructor(){super(...arguments),this.orientation="vertical",this.selected="",this.size="md",this.selectionStyle="",this.tools=[],this.showHotkeys=!0}updated(e){e.has("selectionStyle")&&this.selectionStyle&&this.style.setProperty("--toolbar-selection-style",this.selectionStyle)}_handleClick(e){this.selected=e,this.dispatchEvent(new CustomEvent("tool-select",{bubbles:!0,composed:!0,detail:{tool:e}}))}render(){return this.tools&&this.tools.length>0?l.html`
        <div class="toolbar">
    ...
    `],y([c({reflect:!0})],s.Toolbar.prototype,"orientation",2),y([c()],s.Toolbar.prototype,"selected",2),y([c({reflect:!0})],s.Toolbar.prototype,"size",2),y([c({attribute:"selection-style"})],s.Toolbar.prototype,"selectionStyle",2),y([c({type:Array})],s.Toolbar.prototype,"tools",2),y([c({type:Boolean,attribute:"show-hotkeys"})],s.Toolbar.prototype,"showHotkeys",2),s.Toolbar=y([p("tui-toolbar")],s.Toolbar),s.Tool=class extends l.LitElement{constructor(){super(...arguments),this.toolId="",this.icon="",this.active=!1,this.size="md"}_handleClick(){this.dispatchEvent(new CustomEvent("tool-select",{bubbles:!0,composed:!0,detail:{tool:this.toolId}}))}render(){return l.html`
      <tui-button
        variant="icon"
        size=${this.size}
  ...
  `,y([c({attribute:"tool-id"})],s.Tool.prototype,"toolId",2),y([c()],s.Tool.prototype,"icon",2),y([c({type:Boolean,reflect:!0})],s.Tool.prototype,"active",2),y([c()],s.Tool.prototype,"size",2),s.Tool=y([p("tui-tool")],s.Tool);var ct=Object.defineProperty,dt=Object.getOwnPropertyDescriptor,B=(n,e,t,o)=>{for(var r=o>1?void 0:o?dt(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&ct(e,t,r),r};s.Toast=class extends l.LitElement{constructor(){super(...arguments),this.position="bottom",this._queue=[],this._current=null,this._visible=!1}show(e,t={}){const o={message:e,type:t.type||null,title:t.title||this._getDefaultTitle(t.type),duration:t.duration||2500,simple:!t.type&&!t.title};this._queue=[...this._queue,o],this._current||this._showNext()}_getDefaultTitle(e){switch(e){case"success":return"Success";case"error":return"Error";case"warning":return"Warning";case"info":return"Info";default:return""}}async _showNext(){if(this._queue.length===0){this._current=null;return}const[e,...t]=this._queue;this._queue=t,this._current=e,this._visible=!1,await this.updateComplete,requestAnimationFrame(()=>{this._visible=!0}),await new Promise(o=>setTimeout(o,this._current.duration)),this._visible=!1,await new Promise(o=>setTimeout(o,200)),this._showNext()}render(){if(!this._current)return l.html``;const{message:e,type:t,title:o,simple:r}=this._current,i=["toast",this._visible?"visible":"",t?`type-${t}`:"",r?"simple":""].filter(Boolean).join(" ");return l.html`
      <div class="${i}">
    ...
    `],B([c({type:String,reflect:!0})],s.Toast.prototype,"position",2),B([g()],s.Toast.prototype,"_queue",2),B([g()],s.Toast.prototype,"_current",2),B([g()],s.Toast.prototype,"_visible",2),s.Toast=B([p("tui-toast")],s.Toast);let Q=null;function ht(n,e){Q||(Q=document.createElement("tui-toast"),document.body.appendChild(Q)),Q.show(n,e)}var pt=Object.defineProperty,ut=Object.getOwnPropertyDescriptor,P=(n,e,t,o)=>{for(var r=o>1?void 0:o?ut(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&pt(e,t,r),r};const S=L.single,E=L.heavy,C=L.double;s.Card=class extends l.LitElement{constructor(){super(...arguments),this.rank="",this.suit="",this.faceDown=!1,this.selected=!1,this.disabled=!1,this.size="md"}get isRed(){return this.suit==="♥"||this.suit==="♦"}_handleClick(){this.disabled||this.dispatchEvent(new CustomEvent("card-click",{bubbles:!0,composed:!0,detail:{rank:this.rank,suit:this.suit}}))}render(){const e=this.isRed?"suit red":"suit",t=`size-${this.size}`;return l.html`
      <div 
    ...
    `}},s.Card.styles=[m,l.css`
      ...
      /* ═══════════════════════════════════════════════════════════════════
         NEUTRAL STATE - Single line border ${l.unsafeCSS(S.tl)}${l.unsafeCSS(S.h)}${l.unsafeCSS(S.h)}${l.unsafeCSS(S.tr)}
         ═══════════════════════════════════════════════════════════════════ */
    ...
    `],P([c({type:String})],s.Card.prototype,"rank",2),P([c({type:String})],s.Card.prototype,"suit",2),P([c({type:Boolean,attribute:"face-down",reflect:!0})],s.Card.prototype,"faceDown",2),P([c({type:Boolean,reflect:!0})],s.Card.prototype,"selected",2),P([c({type:Boolean,reflect:!0})],s.Card.prototype,"disabled",2),P([c({type:String,reflect:!0})],s.Card.prototype,"size",2),s.Card=P([p("tui-card")],s.Card);var mt=Object.defineProperty,ft=Object.getOwnPropertyDescriptor,N=(n,e,t,o)=>{for(var r=o>1?void 0:o?ft(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&mt(e,t,r),r};s.Palette=class extends l.LitElement{constructor(){super(...arguments),this.palettes={},this.currentPalette="",this.selectedChar="",this.columns=8}get _chars(){return this.palettes[this.currentPalette]||[]}_selectPalette(e){var o;const t=((o=this.palettes[e])==null?void 0:o[0])||"";this.dispatchEvent(new CustomEvent("palette-change",{bubbles:!0,composed:!0,detail:{palette:e,firstChar:t}}))}_selectChar(e){this.dispatchEvent(new CustomEvent("char-select",{bubbles:!0,composed:!0,detail:{char:e}}))}render(){const e=Object.keys(this.palettes);return l.html`
      <div class="tabs">
        ${e.map(t=>l.html`
          <button
    ...
    `],N([c({type:Object})],s.Palette.prototype,"palettes",2),N([c({type:String,attribute:"current-palette"})],s.Palette.prototype,"currentPalette",2),N([c({type:String,attribute:"selected-char"})],s.Palette.prototype,"selectedChar",2),N([c({type:Number})],s.Palette.prototype,"columns",2),s.Palette=N([p("tui-palette")],s.Palette);var bt=Object.defineProperty,vt=Object.getOwnPropertyDescriptor,ee=(n,e,t,o)=>{for(var r=o>1?void 0:o?vt(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&bt(e,t,r),r};s.Link=class extends l.LitElement{constructor(){super(...arguments),this.href="",this.type="external",this._copied=!1}_handleClick(){this.type==="external"&&this.href?window.open(this.href,"_blank","noopener"):this.type==="copy"&&this.href&&navigator.clipboard.writeText(this.href).then(()=>{this._copied=!0,this.dispatchEvent(new CustomEvent("copy",{detail:{value:this.href},bubbles:!0,composed:!0})),setTimeout(()=>{this._copied=!1},1500)})}render(){const e=this.type==="external"?"↗":"⧉";return l.html`
    ...
    `],ee([c({type:String})],s.Link.prototype,"href",2),ee([c({type:String,reflect:!0})],s.Link.prototype,"type",2),ee([g()],s.Link.prototype,"_copied",2),s.Link=ee([p("tui-link")],s.Link);var gt=Object.defineProperty,yt=Object.getOwnPropertyDescriptor,ae=(n,e,t,o)=>{for(var r=o>1?void 0:o?yt(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&gt(e,t,r),r};s.ActionList=class extends l.LitElement{constructor(){super(...arguments),this.items=[],this.selected=""}_handleClick(e,t){this.selected===e?(this.selected="",this.dispatchEvent(new CustomEvent("item-deselect",{bubbles:!0,composed:!0}))):(this.selected=e,this.dispatchEvent(new CustomEvent("item-select",{detail:{id:e,label:t},bubbles:!0,composed:!0})))}_colorVar(e){return e?{success:"var(--color-success)",error:"var(--color-error)",warning:"var(--color-warning)",primary:"var(--color-primary)",muted:"var(--text-muted)"}[e]??e:""}_hasActions(e){var o;const t=(o=this.shadowRoot)==null?void 0:o.querySelector(`slot[name="actions-${e}"]`);return!!t&&t.assignedNodes().length>0}render(){return this.items.length===0?l.html`<div class="empty">No items</div>`:l.html`${this.items.map(e=>{const t=this._colorVar(e.color),o=this.selected===e.id;return l.html`
        <div
          class="item ${o?"active":""}"
    ...
    `],ae([c({type:Array})],s.ActionList.prototype,"items",2),ae([c({type:String,reflect:!0})],s.ActionList.prototype,"selected",2),s.ActionList=ae([p("tui-action-list")],s.ActionList);var _t=Object.defineProperty,wt=Object.getOwnPropertyDescriptor,te=(n,e,t,o)=>{for(var r=o>1?void 0:o?wt(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&_t(e,t,r),r};s.Stat=class extends l.LitElement{constructor(){super(...arguments),this.label="",this.value="",this.color=""}render(){return l.html`
    ...
    `],te([c({type:String})],s.Stat.prototype,"label",2),te([c({type:String})],s.Stat.prototype,"value",2),te([c({type:String,reflect:!0})],s.Stat.prototype,"color",2),s.Stat=te([p("tui-stat")],s.Stat);var $t=Object.defineProperty,xt=Object.getOwnPropertyDescriptor,W=(n,e,t,o)=>{for(var r=o>1?void 0:o?xt(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&$t(e,t,r),r};s.StatusStrip=class extends l.LitElement{constructor(){super(...arguments),this.label=""}render(){return l.html`
    ...
    `],W([c({type:String})],s.StatusStrip.prototype,"label",2),s.StatusStrip=W([p("tui-status-strip")],s.StatusStrip),s.StripItem=class extends l.LitElement{constructor(){super(...arguments),this.color="",this.indicator=""}render(){return l.html`
    ...
    `],W([c({type:String,reflect:!0})],s.StripItem.prototype,"color",2),W([c({type:String})],s.StripItem.prototype,"indicator",2),s.StripItem=W([p("tui-strip-item")],s.StripItem);var St=Object.defineProperty,Et=Object.getOwnPropertyDescriptor,ne=(n,e,t,o)=>{for(var r=o>1?void 0:o?Et(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&St(e,t,r),r};s.Titlebar=class extends l.LitElement{constructor(){super(...arguments),this.app="",this.section=""}render(){return l.html`
      ${this.app?l.html`
    ...
    `],ne([c({type:String})],s.Titlebar.prototype,"app",2),ne([c({type:String})],s.Titlebar.prototype,"section",2),s.Titlebar=ne([p("tui-titlebar")],s.Titlebar);var Ct=Object.defineProperty,zt=Object.getOwnPropertyDescriptor,Y=(n,e,t,o)=>{for(var r=o>1?void 0:o?zt(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&Ct(e,t,r),r};const _e="var(--tui-tiled-footer-height, 120px)",kt={monitor:"status status | main aside-1 | main aside-2",viewer:"primary secondary | detail detail",console:"main | footer","console-split":"main aside | footer footer",triad:"left center right"};function we(n){const t=n.split("|").map(v=>v.trim()).filter(Boolean).map(v=>v.split(/\s+/)),o=t.map(v=>`"${v.join(" ")}"`).join(" "),r=Math.max(...t.map(v=>v.length)),i=Array(r).fill("1fr").join(" "),a=new Set,d=[];for(const v of t)for(const _ of v)a.has(_)||(a.add(_),d.push(_));const h=t.length-1,u=t.map((v,_)=>{const $e=new Set(v).size===1;return t.length>1&&$e&&_===0?"auto":t.length>1&&$e&&_===h?_e:"1fr"});if(!u.includes("1fr")){const v=u.findIndex(_=>_!==_e);u[v===-1?0:v]="1fr"}const f=u.join(" ");return{areas:o,rows:f,cols:i,slotNames:d}}s.Tiled=class extends l.LitElement{constructor(){super(...arguments),this.preset="",this.areas="",this.gap="1px",this.labels=""}_getGrid(){const e=this.preset?kt[this.preset]:this.areas;return e?we(e):null}_getDisplayLabels(e){if(!this.preset||!this.areas)return{};const t=this.areas.split("|").flatMap(r=>r.trim().split(/\s+/)).filter(Boolean),o={};return e.forEach((r,i)=>{t[i]&&(o[r]=t[i])}),o}render(){const e=this._getGrid();if(!e)return l.nothing;const t=`
    ...
    `],Y([c({type:String,reflect:!0})],s.Tiled.prototype,"preset",2),Y([c({type:String})],s.Tiled.prototype,"areas",2),Y([c({type:String})],s.Tiled.prototype,"gap",2),Y([c({type:String})],s.Tiled.prototype,"labels",2),s.Tiled=Y([p("tui-tiled")],s.Tiled);var Pt=Object.defineProperty,Ot=Object.getOwnPropertyDescriptor,D=(n,e,t,o)=>{for(var r=o>1?void 0:o?Ot(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&Pt(e,t,r),r};s.Input=class extends l.LitElement{constructor(){super(...arguments),this.value="",this.placeholder="",this.disabled=!1,this.name="",this.label=""}handleEvent(e){if(e.type==="clear"){this.value="";return}const t=e.data;t.value!=null&&(this.value=String(t.value)),t.placeholder!=null&&(this.placeholder=String(t.placeholder)),t.disabled!=null&&(this.disabled=!!t.disabled),t.label!=null&&(this.label=String(t.label))}_onInput(e){const t=e.target;this.value=t.value,this.dispatchEvent(new CustomEvent("tui-input",{bubbles:!0,composed:!0,detail:{value:this.value}}))}_onChange(e){const t=e.target;this.value=t.value,this.dispatchEvent(new CustomEvent("tui-change",{bubbles:!0,composed:!0,detail:{value:this.value}}))}render(){return l.html`
    ...
    `],I([c({type:Boolean,reflect:!0})],s.Checkbox.prototype,"checked",2),I([c({type:Boolean,reflect:!0})],s.Checkbox.prototype,"disabled",2),I([c()],s.Checkbox.prototype,"name",2),I([c()],s.Checkbox.prototype,"value",2),I([c()],s.Checkbox.prototype,"label",2),s.Checkbox=I([p("tui-checkbox")],s.Checkbox);var It=Object.defineProperty,At=Object.getOwnPropertyDescriptor,A=(n,e,t,o)=>{for(var r=o>1?void 0:o?At(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&It(e,t,r),r};s.Radio=class extends l.LitElement{constructor(){super(...arguments),this.checked=!1,this.disabled=!1,this.name="",this.value="",this.label=""}handleEvent(e){if(e.type==="clear"){this.checked=!1;return}const t=e.data;t.checked!=null&&(this.checked=!!t.checked),t.disabled!=null&&(this.disabled=!!t.disabled),t.label!=null&&(this.label=String(t.label))}_select(){this.disabled||this.checked||(this.checked=!0,this.dispatchEvent(new CustomEvent("tui-change",{bubbles:!0,composed:!0,detail:{checked:!0,value:this.value,name:this.name}})))}_onKeydown(e){(e.key===" "||e.key==="Enter")&&(e.preventDefault(),this._select())}render(){return l.html`
      <div class="radio"
           role="radio"
           aria-checked="${this.checked}"
           tabindex="${this.disabled?-1:0}"
    ...
    `],X([c()],s.RadioGroup.prototype,"name",2),X([c()],s.RadioGroup.prototype,"label",2),X([c({type:Boolean,reflect:!0})],s.RadioGroup.prototype,"disabled",2),X([c()],s.RadioGroup.prototype,"value",2),s.RadioGroup=X([p("tui-radio-group")],s.RadioGroup);var jt=Object.defineProperty,Bt=Object.getOwnPropertyDescriptor,F=(n,e,t,o)=>{for(var r=o>1?void 0:o?Bt(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&jt(e,t,r),r};s.Progress=class extends l.LitElement{constructor(){super(...arguments),this.value=0,this.label="",this.total=0,this.current=0}handleEvent(e){if(e.type==="clear"){this.value=0,this.label="",this.total=0,this.current=0;return}const t=e.data;t.value!=null&&(this.value=t.value),t.label!=null&&(this.label=t.label),t.total!=null&&(this.total=t.total),t.current!=null&&(this.current=t.current)}get _clampedValue(){return Math.max(0,Math.min(1,this.value))}render(){const e=Math.round(this._clampedValue*100);return l.html`
      <div class="progress">
        <div class="header">
          ${this.label?l.html`<span class="label">${this.label}</span>`:""}
          <span class="stats">
    ...
    `],F([c({type:Number})],s.Progress.prototype,"value",2),F([c({type:String})],s.Progress.prototype,"label",2),F([c({type:Number})],s.Progress.prototype,"total",2),F([c({type:Number})],s.Progress.prototype,"current",2),s.Progress=F([p("tui-progress")],s.Progress);var Nt=Object.defineProperty,Wt=Object.getOwnPropertyDescriptor,le=(n,e,t,o)=>{for(var r=o>1?void 0:o?Wt(e,t):e,i=n.length-1,a;i>=0;i--)(a=n[i])&&(r=(o?a(e,t,r):a(r))||r);return o&&r&&Nt(e,t,r),r};const Yt={success:"✓",error:"✗",warn:"⚠",info:"ℹ",pending:"…"};s.Status=class extends l.LitElement{constructor(){super(...arguments),this.state="",this.message=""}handleEvent(e){if(e.type==="clear"){this.state="",this.message="";return}const t=e.data;t.state!=null&&(this.state=t.state),t.message!=null&&(this.message=t.message)}render(){return this.state?l.html`
      <div class="badge ${this.state}">
        <span class="indicator">${Yt[this.state]??""}</span>
    ...
    `],le([c({type:String})],s.Status.prototype,"state",2),le([c({type:String})],s.Status.prototype,"message",2),s.Status=le([p("tui-status")],s.Status),s.BORDER_CHARS=L,s.STATE_BORDERS=We,s.ansiToHtml=K,s.getBorderChars=fe,s.parseAreas=we,s.sharedStyles=m,s.titleDecoration=H,s.tuiToast=ht,Object.defineProperty(s,Symbol.toStringTag,{value:"Module"})});
