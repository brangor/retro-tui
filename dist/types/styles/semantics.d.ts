 ...
 */
export declare const SEMANTIC_COLORS: readonly ["primary", "secondary", "success", "warning", "error", "info", "muted"];
export type SemanticColor = (typeof SEMANTIC_COLORS)[number] | '';
/** The CSS custom property each semantic value resolves to. */
export declare const SEMANTIC_TOKENS: Record<(typeof SEMANTIC_COLORS)[number], string>;
