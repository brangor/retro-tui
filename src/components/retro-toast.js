...
customElements.define('retro-toast', RetroToast);

// Singleton helper for easy access
let _toastInstance = null;

export function retroToast(message, options) {
  if (!_toastInstance) {
    _toastInstance = document.createElement('retro-toast');
