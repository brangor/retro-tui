...
export class RetroStatusbar extends LitElement {
  ...
  static styles = [
    ...
    css`
      ...
      ::slotted(retro-status-item) {
        border-right: 1px solid var(--bar-color);
      }

      ::slotted(retro-status-item:last-child) {
        border-right: none;
      }
    `,
  ];
...
/**
 * <retro-status-item> - Single status bar item
 * 
 ...
 */
export class RetroStatusItem extends LitElement {
  static properties = {
    label: { type: String },
    value: { type: String },
...
customElements.define('retro-statusbar', RetroStatusbar);
customElements.define('retro-status-item', RetroStatusItem);
